        ...
        <ThemedView style={styles.content}>
          <View style={styles.emptyState}>
            ...
            <TouchableOpacity style={styles.createButton} onPress={() => router.back()}>
              <ThemedText style={styles.createButtonText}>Go to Home</ThemedText>
            </TouchableOpacity>
            {!isAuthenticated && (
              <TouchableOpacity
          ...
          >
            ...
            <View style={styles.saleDetails}>
              ...
              <View style={styles.detailRow}>
                ...
                <ThemedText style={styles.detailText}>{formatDate(sale.date)}</ThemedText>
              </View>
            ...
            <View style={styles.actions}>
              ...
              {!sale.videoUrl && (
                ...
                >
                  <ThemedText style={styles.actionButtonText}>📹 Add Video</ThemedText>
                </TouchableOpacity>
              )}
              ...
              <TouchableOpacity
                style={[
                  styles.actionButton,
                  sale.isActive ? styles.deactivateButton : styles.activateButton,
                ]}
